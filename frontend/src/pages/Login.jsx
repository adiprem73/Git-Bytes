...
const Login = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen w-full bg-[#0A0A0F] flex items-start justify-center pt-16 relative overflow-hidden">
        ...
        {/* Login card */}
        <div className="w-full max-w-[380px] bg-[#151518] bg-opacity-90 backdrop-blur-md rounded-[20px] p-6 z-10 shadow-lg relative mx-4 animate-fadeIn">
          {/* Glowing border effect */}
          <div className="absolute inset-0 rounded-[20px] animate-pulse"></div>

          {/* Logo and header */}
          <div className="text-center mb-6">
            <h1 className="text-[#00FF8A] text-3xl font-bold font-mono mb-1">WebSecScan</h1>
            <p className="text-gray-400 font-mono text-sm">Advanced Security Platform</p>
            <div className="h-px bg-gradient-to-r from-transparent via-[#00FF8A] to-transparent opacity-30 my-3"></div>
          </div>

          <h2 className="text-white text-xl font-bold font-mono mb-5">Login</h2>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#1A1A1F] border border-[#2A2A30] focus:border-[#00FF8A] text-white font-mono rounded-xl px-4 py-2.5 outline-none focus:ring-1 focus:ring-[#00FF8A] transition-all duration-300 text-sm"
          ...
          <div className="h-px bg-gradient-to-r from-transparent via-gray-700 to-transparent my-5"></div>

          <div className="text-center font-mono text-sm">
            <span className="text-gray-400">Don't have an account?</span>{' '}
            <a href="#" className="text-[#00FF8A] hover:underline cursor-pointer transition-all duration-300"><Link to="/">Sign Up</Link></a>
          </div>
